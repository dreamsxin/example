...
LDLIBSOPTIONS=-Wl,-rpath,/usr/local/lib -lcppcms
...
${OBJECTDIR}/hello.o: hello.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hello.o hello.cpp
