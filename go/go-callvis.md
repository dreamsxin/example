...
go-callvis -include github.com/go-kit/kit -group pkg,type -skipbrowser main.go
go-callvis -format=png -include github.com/go-kit/kit -group pkg -skipbrowser main.go
```
