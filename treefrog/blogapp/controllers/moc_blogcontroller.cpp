...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BlogController_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 53, 6)
    ...
    "BlogController\0index\0\0show\0pk\0entry\0"
    "create\0edit\0save\0remove\0"
};
...
const QMetaObject BlogController::staticMetaObject = {
    { &ApplicationController::staticMetaObject, qt_meta_stringdata_BlogController.data,
      qt_meta_data_BlogController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BlogController.stringdata))
