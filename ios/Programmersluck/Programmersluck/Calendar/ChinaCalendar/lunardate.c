...
const int MonthAdd[12];
const char *chinese_days[30];
const char *chinese_months[12];
const char *chinese_zodiac[12];
const char *chinese_tigan[10];
const char *chinese_dizhi[12];
...
const char *lunardate_day(int lunarday) {
    return chinese_days[lunarday - 1];
}

const char *lunardate_month(int lunarmonth) {
    return chinese_months[lunarmonth - 1];
}
...
const char *chinese_zodiac[12] = { "鼠", "牛", "虎", "免", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪" };

const char *chinese_tigan[10] = { "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸" };
const char *chinese_dizhi[12] = { "子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥" };